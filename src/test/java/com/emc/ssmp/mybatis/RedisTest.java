...
/**
 * @author 作者: Roger.Li
 * @version 创建时间：2017年6月28日 上午10:48:02 类说明 :
 */
...
//		new RedisTest().testString(jedis);
//		String info = jedis.info();
//		System.out.println(info);
//		Map<String, Object> a = new RedisService().getRedisInfo(info);
//		for (String key : a.keySet()) {
//			System.out.println("key:"+key+" value:"+a.get(key).toString());
//		}
		System.out.println(new RedisTest().getConnection("10.116.0.131", 6380, "admin"));;
	}
	
	public Boolean getConnection(String hostIp, int port, String password){
